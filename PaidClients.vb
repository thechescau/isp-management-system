...
Public Class PaidClients
    Dim MysqlConn As MySqlConnection
    Dim COMMAND As MySqlCommand
    Dim Str As String

    Private Sub PaidClients_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Sub paidc()
        Try
            Str = "select * from isp_database.bill_table where status = 'PAID'"
            MysqlConn.Open()
