...
Public Class DisconnectedClients
    ...
    Public Sub disconnected()
        Try
            Str = "select * from isp_database.bill_table where connection = 'DISCONNECTED'"
            MysqlConn.Open()
    ...
    Private Sub DisconnectedClients_Load(sender As Object, e As EventArgs) Handles MyBase.Load
